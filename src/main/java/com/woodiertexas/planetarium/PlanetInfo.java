 ...
 */
public record PlanetInfo(float procession, float tilt, float inclination, float texture_rotation, float size, Optional<ResourceLocation> texture_override) {
	public static final Codec<PlanetInfo> CODEC = RecordCodecBuilder.create(instance ->
		instance.group(
			...
			ResourceLocation.CODEC.optionalFieldOf("texture_override").forGetter(PlanetInfo::texture_override)
